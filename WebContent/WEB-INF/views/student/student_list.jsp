	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'studentId',title:'学号',width:150, sortable: true},
 		        ...
 		        {field:'photo',title:'照片',width:150, sortable: true,
 		        	formatter:function(value, index){
	    ...
	    $("#addDialog").dialog({
							...
							$.ajax({
								...
								success: function(data){
									if(data.type == "success"){
										...
										$("#add_gender").combobox('setValue', "");
										$("#add_clazzId").combobox('setValue', "");
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_gender").combobox('setValue', selectRow.gender);
	  	...
	  	//上传图片按钮
	  	 $("#upload-btn").click(function(){
	  		if($("#upload-photo").filebox("getValue") == ''){
	  			$.messager.alert("消息提醒","你可能是个不会上传文件的弱智嗷","warning");
	  			return
	  		} 
	  		$("#photoForm").submit();
	  	 });
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			学生名搜索<input id="search-name" class="easyui-textbox">
			所属年级<select id="search-clazzId" class="easyui-combobox" style="width: 200px;">
	...
	<div id="addDialog" style="padding: 10px;">  
		<form id="photoForm" method="post" enctype="multipart/form-data" action="uploadPhoto" target="photo_target">
	    	<table id="addTable1" cellpadding="6" >
	    		<tr>
	    			<td style="width:60px">预览头像</td>
	    			<td colspan="3">
	    				<img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 200px;" title="照片" src="/StudentManager/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td style="width:60px">学生照片</td>
	    			<td colspan="3">
	    				<input id="upload-photo" class="easyui-filebox" name="photo" data-options="prompt:'选择照片'" style="width:200px;" />
	    				<a id="upload-btn" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">
	    					图片上传
	    				</a>
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable2" cellpadding="6" >
	    		...
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<select id="add_gender"  class="easyui-combobox" style="width: 200px;" name="gender" data-options="required:true, missingMessage:'请选择性别'" >
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editPhotoForm" method="post" enctype="multipart/form-data" action="uploadPhoto" target="photo_target">
	    	<table id="editTable1" cellpadding="6" >
	    		<tr>
	    			<td style="width:60px">预览头像</td>
	    			<td colspan="3">
	    				<img id="edit-photo-preview" alt="照片" style="max-width: 100px; max-height: 200px;" title="照片" src="/StudentManager/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td style="width:60px">学生照片</td>
	    			<td colspan="3">
	    				...
	    				<a id="edit-upload-btn" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">
	    					图片上传
	    				</a>
   		...
   		<form id="editForm" method="post">
	    	...
	    	<table id="editTable2" cellpadding="6" >
	    		<input id="edit_photo" type="hidden" name="photo" value="/StudentManager/photo/student.jpg" />	
	    		<tr>
	    			<td style="width:60px">学生姓名</td>
	    			<td colspan="3">
	    				<input id="edit_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请输入学生姓名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td style="width:60px">登录密码</td>
	    		...
	    		<tr>
	    			<td style="width:60px">性别</td>
	    			<td colspan="3">
	    				<select id="edit_gender"  class="easyui-combobox" style="width: 200px;" name="gender" data-options="required:true, missingMessage:'请选择性别'" >
	    					<option value="男">男</option>
	    					<option value="女">女</option>
	    				</select>
	    			</td>
