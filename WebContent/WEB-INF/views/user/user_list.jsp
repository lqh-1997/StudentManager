							...
							$.ajax({
								...
								success: function(data){
									if(data.type == "success"){
										...
										$("#edit_passwordd").textbox('setValue', "");
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			用户名搜索<input id="search-username" class="easyui-textbox">
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="6" >
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请输入姓名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" cellpadding="6" >
	    		<tr>
	    			<td style="width:40px">姓名</td>
	    			<td colspan="3">
	    				<input id="edit_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请输入姓名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
